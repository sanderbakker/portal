<?php
require_once 'includes/createDatabase.php';
...
<div class="buttons">
    <a href="customers/index.php" role="button" class="btn btn-info"><i class="fa fa-users"></i> Customers</a>
    <a href="login/index.php" role="button" class="btn btn-info"><i class="fa fa-user"></i> Users</a>
</div>